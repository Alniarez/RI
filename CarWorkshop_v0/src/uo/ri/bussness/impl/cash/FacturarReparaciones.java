package uo.ri.bussness.impl.cash;
...
public class FacturarReparaciones {
    ...
    public void execute() throws BusinessException {
        try {
            ...
            fechaFactura = DateUtil.today();
            totalFactura = calcularImportesAverias(idsAveria);
            iva = porcentajeIva(totalFactura, fechaFactura);
            importe = totalFactura * (1 + iva / 100);
