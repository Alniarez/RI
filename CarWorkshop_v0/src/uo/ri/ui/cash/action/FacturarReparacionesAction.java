...
public class FacturarReparacionesAction implements Action {
	...
	public void execute() throws BusinessException {
		...
		Map<String, Object> m = cs.facturarRepareciones(idsAveria).get(0);//Get 0 porque es una lista de mapas

		mostrarFactura((long) m.get("numeroFactura"),
				(Date) m.get("fechaFactura"), (double) m.get("totalFactura"),
				(double) m.get("iva"), (double) m.get("importe"));
